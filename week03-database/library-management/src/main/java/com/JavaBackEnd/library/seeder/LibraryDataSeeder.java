package com.JavaBackEnd.library.seeder;

import com.JavaBackEnd.library.entity.*;
import com.JavaBackEnd.library.repository.*;
...
public class LibraryDataSeeder {
    ...
    public void seed() {
        ...
        fowler.setBiography("Author of Refactoring and Patterns of Enterprise Application Architecture");
        ...
        System.out.println("✅ Library data seeded successfully!");
